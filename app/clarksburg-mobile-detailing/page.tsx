...
export default function ClarksburgContent() {
        ...
        <>
            ...
            <section className="bg-white py-16 px-4 sm:px-8 lg:px-20">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-8">
                        <div className="w-full sm:w-1/2 h-[400px] relative border border-gray-300 rounded-lg overflow-hidden">
                            <Image
                                fill
            ...
            <section className="px-6 py-12 md:py-20 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <ul className="space-y-2 text-base font-medium">
                            {serviceAreas.map((area) => {
                                const isCurrent = area.href === '/clarksburg-mobile-detailing';
                                return (
                                    <li key={area.label}>
                                        <Link
                                            href={area.href}
                    ...
                    <div className="relative w-full h-[700px] rounded-lg shadow-lg overflow-hidden">
                        <Image
                            src="/images/clarksburg-hero.jpg"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {Array.from({ length: 24 }, (_, i) => (
                            <div key={i} className="relative w-full h-64 overflow-hidden rounded-md">
                                <Image
                                    src={`/images/gallery/clarksburg-${i + 1}.jpg`}
                                    alt={`Clarksburg Gallery Image ${i + 1}`}
                                    fill
